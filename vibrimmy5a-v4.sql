...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2023 a las 07:46:28
...
(2, 2, 'GRUPO 2', '1', '', '2023-09-24 14:08:43'),
(4, 3, 'Grupo Alfa', '1', '', '2023-05-04 23:14:25'),
(11, 1, 'GRUPO OTRO', '1', 'jansforte@gmail.com', '2023-09-28 23:08:29');
...
INSERT INTO `tbl_grupstud` (`codigoGrupstud`, `codigoGrupoxxx`, `codigoEstudnte`, `codigoProyecto`) VALUES
(2, 1, 1152461197, 1),
(3, 2, 1077875338, 2),
(4, 11, 1077875338, 5);
...
(14, 4, 'Se crea la tarea al estudiante', '', '1', 'jansforte@gmail.com', '2023-09-23 17:18:30'),
(15, 5, 'Se crea la tarea al estudiante', '', '1', 'jansforte@gmail.com', '2023-09-24 13:13:50'),
(16, 2, 'Prueba del estudiante', '', '1', 'johanyjeison@gmail.com', '2023-10-02 22:30:05'),
(17, 2, 'Listo listooooo', '', '2', 'johanyjeison@gmail.com', '2023-10-02 22:30:29');
...
CREATE TABLE `tbl_proyecto` (
  ...
  `documeProyecto` varchar(120) DEFAULT NULL,
  `fechaxRegistro` datetime NOT NULL,
...
(5, 1077875338, 1, 1, 'proyecto 22', 'La finalidad del proyecto es tales y pascuales con cuales', '', '2023-10-03 00:25:55', NULL, NULL, 2);
...
CREATE TABLE `tbl_tareaxxx` (
  `codigoTareaxxx` int(11) NOT NULL,
  `codigoProyecto` int(11) NOT NULL,
  `codigoEtapaxxx` int(11) DEFAULT NULL,
...
INSERT INTO `tbl_tareaxxx` (`codigoTareaxxx`, `codigoProyecto`, `codigoEtapaxxx`, `nombreTareaxxx`, `descriTareaxxx`, `fechaxTareaxxx`, `numeroEstadoxx`, `usuariCreacion`, `fechaxCreacion`, `usuariModifica`, `fechaxModifica`, `usuariGestionx`, `fechaxGestionx`, `usuariAprobado`, `fechaxAprobado`) VALUES
(1, 2, 3, 'Investigar Empresas', 'Investigar tipos de empresas y los productos de acuerdo a mi invento ', '2023-08-31', '1', 'jansforte@gmail.com', '2023-08-31 23:24:00', 'jansforte@gmail.com', '2023-09-10 23:26:55', 'jansforte@gmail.com', NULL, 'jansforte@gmail.com', '2023-09-10 23:12:16'),
(2, 2, 3, 'tarea 2', 'ok ', '2023-09-04', '2', 'jansforte@gmail.com', '2023-09-03 16:24:06', 'jansforte@gmail.com', '2023-09-10 23:27:04', 'johanyjeison@gmail.com', '2023-10-02 22:30:29', NULL, NULL),
(3, 2, 3, 'otro', 'fsdf', '2023-09-03', '3', 'jansforte@gmail.com', '2023-09-03 16:25:54', NULL, NULL, 'jansforte@gmail.com', '2023-09-03 18:33:13', 'jansforte@gmail.com', '2023-09-06 23:49:51'),
(4, 2, 3, 'nueva Tarea', 'Realizar la actividad de pasatiempo', '2023-09-25', '3', 'jansforte@gmail.com', '2023-09-23 17:18:30', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 1, 1, 'Investigar SOS', 'Actividad de recuperación de datos', '2023-09-24', '1', 'jansforte@gmail.com', '2023-09-24 13:13:50', NULL, NULL, NULL, NULL, NULL, NULL);
...
('jansforte@gmail.com', 'admin', '12345', 1, 'ya29.a0AfB_byBDcU3Is0fISxGzdUwVz4FMKLm0mWOdfk0QT3oEeSyhKlanCUzHVEB_pzQu_UpGJDS1VsSrKM_kfoFulMGIvdReHM46sCGq0KLQfXEUmTA5z3wotBBOvOjh76pQV3S-FCweo84lnmDLMk2BCAw_lCfOAqL6AgaCgYKAVkSARASFQGOcNnC0Yk4pdpYRNf9Uc80_CSjLw0169', '1', '2023-10-03 22:05:57'),
('jeyadrey16@gmail.com', 'Jeison Andres Fuentes Ortega', '987', 3, NULL, '0', '2022-10-17 18:05:39'),
('johanyjeison@gmail.com', 'Jans Forte', '1234', 3, 'ya29.a0AfB_byDdLGhLv_vulptkz1ODRImImXr3VgXJEPpchPLnRgzlXWwYq3Hq_YT8ygm63q2kh26Xme8Wu2wwC7xvLR7AFaal7ZoYS9umXzSJLrq11Kor222zpWLs3z1EBD3fFEiDAc1P5DJYlcZlGeAUDewWsE_D2_2MAaIaCgYKAYISARISFQGOcNnCht96frTaiI9THbskHHw5_w0170', '0', '2023-10-03 23:59:00'),
('elpelosraspado@uceva.edu.co', 'El pelos raspado', '1234', 2, NULL, '0', '2023-10-02 22:25:08'),
...
--
ALTER TABLE `tbl_grupdocn`
  MODIFY `codigoGrupdocn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `tbl_grupstud`
  MODIFY `codigoGrupstud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `tbl_histarea`
--
ALTER TABLE `tbl_histarea`
  MODIFY `codigoHistarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tbl_proyecto`
  MODIFY `codigoProyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_tareaxxx`
  MODIFY `codigoTareaxxx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
