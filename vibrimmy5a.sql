...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-03-2023 a las 05:50:40
...
(11121131, 1, 2, 'Profesor', 'Rogelio', 'M', '2022-10-08', 'Docente', '3211112233', 'calle 5A23A36', 'johan.fuentes01@uceva.edu.co', '2022-10-09 03:36:47'),
...
(5, '1152461197', '23:17:00', '23:19:00', '11:17:00', '23:17:00', '11:17:00', '17:17:00', '16:17:00', '18:17:00', '19:17:00', '21:18:00'),
(8, '1077875338', '23:32:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(4, 1, 'Evento de Proyección social', 'success.jpg', 'La proyección social ', '2023-04-23', '12:00:00', '14:00:00', '1', 'jansforte@gmail.com', '2023-03-05 23:15:47'),
(5, 1, 'Evento Empresarial', 'algo.png', 'Robotica Empresarial', '2023-03-21', '16:00:00', '18:00:00', '1', 'jansforte@gmail.com', '2023-03-05 14:36:37');
...
CREATE TABLE `tbl_grupoxxx` (
  ...
  `codigoEtapaxxx` int(11) NOT NULL,
  `codigoEstudnte` int(11) NOT NULL,
  `nombreGrupoxxx` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(5, '11121131', 'Solicitud de Asesoria', 'El estudiante Jans Forte te pidió una solicitud de Asesoria', '0', 'meet', '2023-02-27 22:42:54'),
(6, '1152461197', 'Revisión de Proyecto', 'El Docente ha revisado tu proyecto', '0', 'proyect', '2023-02-27 22:44:12'),
(7, '1077875338', 'Asesoria aceptada', 'El Docente ha aceptado tu asesoría', '0', 'meet', '2023-02-27 22:45:29'),
...
(10, '1077875338', 'Revisión de Proyecto', 'El Docente ha revisado tu proyecto', '0', 'proyect', '2023-03-05 23:30:42'),
(11, '11121131', 'Solicitud de Asesoria', 'El estudiante Jans Forte te pidió una solicitud de Asesoria', '0', 'meet', '2023-03-05 23:32:29'),
(12, '1077875338', 'Asesoria aceptada', 'El Docente ha aceptado tu asesoría', '0', 'meet', '2023-03-05 23:33:16');
...
(3, 1152461197, 3, 1, 'Sistema de Gestion', 'El sistema de gestion es un proyecto que se encarga de administrar los procesos de un ente como tal', 'Taller.docx', '2022-09-11 19:56:55', 'Pasó a la siguiente etapa', '2023-03-05 23:25:34', 1);
...
('jansforte@gmail.com', 'admin', '12345', 1, 'ya29.a0AVvZVsocfcBiYKu3FRjWD7zQLIk4GJIl0OkD2v8XBB-QQRAosYDvIfPh0mh1sEA3ErVgzbrKUOmWfYSS0Be9B2wqTotlg58hQ7bwvIPtUhDsNeTtXNMy20GZSvgotmvq7eydfPpQ4a3ampjSA-DQDepPuDzckAaCgYKAQoSARASFQGbdwaI31YPoLMlg6gF6n-vHYjxXA0165', '1', '2023-03-05 23:09:50'),
('jeyadrey16@gmail.com', 'Jeison Andres Fuentes Ortega', '987', 3, NULL, '0', '2022-10-17 18:05:39'),
('johanyjeison@gmail.com', 'Jans Forte', '1234', 3, 'ya29.a0AVvZVspAZ_wioA7HmCd1vsNiIUGXLacHAp47_sryLBUiv-h4Vdd9yud4y3FzNEN3V9auZcWk2gOV4Spm_Qt7QSrlgL_yyGKJFrAGiaGhgVwPGvP8PqsWbrNo-_eyd2Mujv5P4-NsTDvT0-sEBqI5ZFjbe1wwaCgYKARgSARISFQGbdwaIYAWeOoCvLhHBSAJPot__cw0163', '0', '2023-03-05 23:26:42'),
('elpelosraspado@uceva.edu.co', 'El pelos raspado', '1234', 2, NULL, '0', '2023-02-25 10:59:58'),
('johan.fuentes01@uceva.edu.co', 'Profesor Rogelio', 'Colombia12', 2, 'ya29.a0AVvZVspVNlZz0bqkvJeHcVYP0b4UkjGQd4pq7tFGVrd1T-6TbNnUiSMyuI_JXJfFk9WgtiBMbrmyjgXXuGqo95MDNPqApNEYqIuHA_YkFgDP3qkiUw3bxhA7HNY5b8vunj8trcp-n79pw7Lpp2-AbV5oWtSXSNQaCgYKAaoSARMSFQGbdwaIRompk9fQAETR9hua1-TIfg0166', '1', '2023-03-05 23:25:17');
...
ALTER TABLE `tbl_grupoxxx`
  ...
  ADD KEY `id_docente` (`codigoDocentex`),
  ADD KEY `id_estado` (`codigoEtapaxxx`),
  ADD KEY `codigoEstudnte` (`codigoEstudnte`);
...
--
ALTER TABLE `tbl_asesoria`
  MODIFY `codigoAsesoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_estudisp`
  MODIFY `codigoEstudisp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbl_histnoti`
  MODIFY `codigoHistnoti` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_grupoxxx`
  ADD CONSTRAINT `tbl_grupoxxx_codigoEstudnt` FOREIGN KEY (`codigoEstudnte`) REFERENCES `tbl_estudnte` (`codigoEstudnte`),
  ADD CONSTRAINT `tbl_grupoxxx_ibfk_1` FOREIGN KEY (`codigoDocentex`) REFERENCES `tbl_docentex` (`codigoDocentex`),
