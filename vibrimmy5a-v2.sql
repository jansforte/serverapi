...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2023 a las 07:00:38
...
INSERT INTO `tbl_grupoxxx` (`codigoGrupoxxx`, `codigoDocentex`, `codigoEtapaxxx`, `nombreGrupoxxx`, `fechaxCreacion`) VALUES
(1, 11121131, 2, 'Grupo 1', '2023-03-20 11:27:42'),
(2, 11121131, 2, 'Grupo 2', '2023-03-20 11:44:41'),
(4, 11121131, 3, 'Grupo Alfa', '2023-05-04 23:14:25');
...
(1, 2, 'Investigar Empresas2', 'Investigar tipos de empresas y los productos de acuerdo a mi invento', '2023-08-31', '1', 'jansforte@gmail.com', '2023-08-31 23:24:00', 'jansforte@gmail.com', '2023-09-01 01:09:09', NULL, NULL, NULL, NULL),
(2, 2, 'tarea 2', 'ok', '2023-09-04', '4', 'jansforte@gmail.com', '2023-09-03 16:24:06', NULL, NULL, 'jansforte@gmail.com', '2023-09-03 20:04:55', NULL, NULL),
...
('jansforte@gmail.com', 'admin', '12345', 1, 'ya29.a0AWY7CkmFtJySjwpo3sp9qQTnJzp2xsb32NbiXiZc4wcm3g_i9Mo2BqHh92GXZT5cVQulASs6_TWxBweF6hrSx29tdkGepVsPDrhu5rB8dw3VvzNY-HIN9Rq0ybaiNH_BqtM5OOJW2QBkj5tLLm54S2fTGSTZsgaCgYKAQESARASFQG1tDrphEH7_95NKSaD9qO-M0eLYw0165', '1', '2023-07-30 15:18:41'),
...
--
ALTER TABLE `tbl_estatare`
  MODIFY `codigoEstatare` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_grupoxxx`
  MODIFY `codigoGrupoxxx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_histarea`
  MODIFY `codigoHistarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
